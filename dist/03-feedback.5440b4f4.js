...
form.addEventListener("input", (0, _lodashThrottleDefault.default)(onFormInput, 500)); // ставимо час для обновлення рядків
...
function onFormInput(e) {
    ...
    const dataFromLocalStorage1 = JSON.parse(localStorage.getItem(LOCAL_KEY));
